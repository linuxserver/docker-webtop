...
Simply pulling `lscr.io/linuxserver/webtop:fedora-icewm` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  webtop:
    image: lscr.io/linuxserver/webtop:fedora-icewm
...
docker run -d \
  ...
  --restart unless-stopped \
  lscr.io/linuxserver/webtop:fedora-icewm
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/webtop:fedora-icewm`
...
* Update the image: `docker pull lscr.io/linuxserver/webtop:fedora-icewm`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/webtop:fedora-icewm .
```
...
* **07.10.22:** - Rebase fedora-icewm to Fedora 36, migrate to s6v3.
