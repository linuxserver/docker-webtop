...
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-webtop%2Fjob%2Ffedora-xfce%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-webtop/job/fedora-xfce/)
...
Simply pulling `lscr.io/linuxserver/webtop:fedora-xfce` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/webtop:fedora-xfce`
...
* Update the image: `docker pull lscr.io/linuxserver/webtop:fedora-xfce`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/webtop:fedora-xfce .
```
...
* **07.10.22:** - Rebase fedora-xfce to Fedora 36, migrate to s6v3.
