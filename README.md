...
Simply pulling `lscr.io/linuxserver/webtop:alpine-i3` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/webtop:alpine-i3`
...
* Update the image: `docker pull lscr.io/linuxserver/webtop:alpine-i3`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/webtop:alpine-i3 .
```
...
* **21.10.22:** - Rebase i3 to Alpine 3.16, migrate to s6v3.
