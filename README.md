...
[![Jenkins Build](https://img.shields.io/jenkins/build?labelColor=555555&logoColor=ffffff&style=for-the-badge&jobUrl=https%3A%2F%2Fci.linuxserver.io%2Fjob%2FDocker-Pipeline-Builders%2Fjob%2Fdocker-webtop%2Fjob%2Farch-kde%2F&logo=jenkins)](https://ci.linuxserver.io/job/Docker-Pipeline-Builders/job/docker-webtop/job/arch-kde/)
...
Simply pulling `lscr.io/linuxserver/webtop:arch-kde` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/webtop:arch-kde`
...
* Update the image: `docker pull lscr.io/linuxserver/webtop:arch-kde`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/webtop:arch-kde .
```
...
* **18.10.22:** - Migrate arch kde to s6v3.
