...
Simply pulling `lscr.io/linuxserver/webtop:arch-xfce` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/webtop:arch-xfce`
...
* Update the image: `docker pull lscr.io/linuxserver/webtop:arch-xfce`
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/webtop:arch-xfce .
```
