...
Instead edit the [readme-vars.yml](https://github.com/linuxserver/docker-webtop/edit/alpine-i3/readme-vars.yml).
...
If you are modifying the Dockerfiles or any of the startup scripts in [root](https://github.com/linuxserver/docker-webtop/tree/alpine-i3/root), add an entry to the changelog
